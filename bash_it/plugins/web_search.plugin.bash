...
# source: https://hackernoon.com/cross-platform-productivity-tool-with-terminal-7dd0487ead93#.6oxf3gey7
alias urban='web_search urban'
alias regex='web_search regex'
alias shell='web_search shell'
alias jsonb='web_search jsonb'
